             	...
             	<ul class="green pricing jcarousel-list jcarousel-list-horizontal">
                  <li>
                        <ul>
		                    ...
		                    <div class="buttons"><button type="submit" class="grey">Buy it now!</button></div>
		                    </form>
                     </ul>
                 </li>
                     <li>
						 <ul>
                           	<li class="title"><h3>Pro</h3><h4>€150<small>/month</small></h4></li>
                    	   	<li class="divider"></li> 
						   	<li>4 Core CPU</li>
		                   	<li>8GB RAM</li>
                    ...
                    <li>
                    	<ul>
		                    <li class="title"><h3>Plus</h3><h4>€208<small>/month</small></h4></li>
		                    <li class="divider"></li>
		                    <li>8 Core CPU</li>
		                    <li>16GB RAM</li>
...
<div class="content_bottom">
	<div class="wrap">
    	<div class="register_account">
    		...
    		<table><tbody><tr><td>
			<input type="email" id="email" name="email" value="E-Mail"/><br/>
			...
			<input type="text" id="telnumber" name="telnumber" value="Telephone number"/><br/>
			<input type="text" id="company" name="company" value="Company Name"/><br/>
			</td></tr></tbody></table>
		   <div class="search"><button type="submit" value="register" class="grey">Create Account</button></div>
        ...
        <div class="login_panel">
 		<h3>Existing Customers</h3>
        	...
        	<form action="login" method="post">
                	<input id="emaillogin" name="emaillogin" type="text" value="Username" class="field">
                    <input id="passlogin" name="passlogin" type="password" value="Password" class="field">
                    <div class="buttons"><div><button type="submit" value="login" class="grey">Sign In</button></div></div>
                 </form>
