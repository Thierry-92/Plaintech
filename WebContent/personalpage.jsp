    ...
    <div class="clear"></div>
     <div class="main">
		<div class="content_top">
			...
			<h3>
			Welcome on your personal page <%out.println(user);%>
			</h3>
			<h4>Check the status of your VM</h4>
			<form action="Status" method="post"> 
				<div class="button"><button type="submit" value="register" class="grey">Click here to check</button></div>
				</form>
			</div>
			</div>
			</div>
      ...
      <div class="main">
		<div class="content_bottom">
			<div class="wrap">
				...
				Choose the amount of CPU's. 	<input name="CPU" id="CPU" type="text"><br>
				Choose the amount of RAM.  		<input name="RAM" id="RAM" type="text"><br>
				Choose the amount of Storage.	<input name="STORAGE" id="STORAGE" type="text">
				<div class="buttons"><button type="submit" value="register" class="grey">Update VM </button></div>
 				</form>
		</div>
		</div>
   </div>
