...
<div class="header">
   ...
   <div class="wrap">
	<h1>About Plaintech</h1>
      <p>Plaintech UK is an internationally operating organization with its main headquarters in
		Birmingham (UK). One division of Plaintech is based in the Netherlands to address the Dutch
		market and Scandinavia. Plaintech has decades of experience in the hosting business.</p>
		<p>&nbsp;</p>
		<h2> Mission: </h2>
		<p>Plaintech delivers the best solution when it comes to server hosting. We focus on the best mix of the desire of the customer, available budget and best technical solution. Therefore we deliver the knowledge and advise to realise this mission.</p>
        <p>•the customer stands central<br>
          •co-operate<br>
          •flexible<br>
          •What you want is what you get<br>
          •Easy order<br>
          •Online selfservice</p>
</div>
   </div>
   </div>
   <div class="clear"></div>
