...
public class Validate { // Gets values for email and pass in welcome method
						// validate.CheckUser(email, pass). set standard value
						// to false so nobody can login without requested
						// values.
